...
import { certificateDialog } from './history/history.component';
import { newPersonDialog } from './cm-nacimiento/CMNacimiento.component';
import { DialogOverviewExampleDialog, RejectDialog } from './procedure/procedure.component';
...
@NgModule({
  ...
  entryComponents: [certificateDialog, previewDialog, newPersonDialog, DialogOverviewExampleDialog, RejectDialog],
